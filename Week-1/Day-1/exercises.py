...
exit_price = int(input("Enter Exit price:"))
lot_size = int(input("Enter Lot size:"))
ounces = lot_size * contract_size
price_movment = exit_price - entry_price
pnl= ounces * price_movment
print(pnl)
...
contract = 100
ounces = lot * contract
price_movment_l = exit - entry
price_movment_s = entry - exit
pnl_l= ounces * price_movment_l
pnl_s= ounces * price_movment_s
